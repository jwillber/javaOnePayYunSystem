                ...
                <div class="text_myshare">
                    ...
                    <ul class="upload">
                        ...
                        <li><span class="pic">上传图片：</span>
                            <div class="uppic">
                                <form enctype="multipart/form-data" target="upFrame" action="PostSingleAddUpLoadImg.html" method="post" name="pageForm" id="pageForm">
                                <div class="upImgLoading hidden"><s></s>上传中</div>
                                <div class="localBtn">
                                    <div class="btn" id="upImgBtn"></div>
                                    <div class="btnFile" id="FileControl">
                                        <input type="file" style="cursor: pointer;" hidefocus="true" name="upload" class="file" title="" accept="image/*" id="fuploadFile" />
                                    </div>
                                </div>
                                </form>
